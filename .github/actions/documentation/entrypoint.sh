...
cargo doc --no-deps --document-private-items --target-dir docs_new
echo "<head><meta http-equiv=\"refresh\" content=\"0; URL=./doc/Elements_of_Programming_in_Rust/index.html\" /></head><body>hello</body>"
git add .
